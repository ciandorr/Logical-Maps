...
From $P\to\Box P$ and the necessitation of the theorem $P\to\Diamond P$ (T), K gives $P\to\Box\Diamond P$.

## Sources

- **Dorr 22 Sep** — Cian Dorr, suggestion of 22 September 2026; proof as recorded.

<p class='cert'>Record: <code>topics/classicism/results/no-contingency-signature-r-implies-signature-b-r.yaml</code></p>
