...
Every closed instance of Relational Choice is a closed sentence of the pure language, since the principle is stated with object-language quantifiers and contains no nonlogical constant. Given Relational Choice, each of those instances is true, and No Pure Contingency makes each necessary, which is □Relational Choice.
...
<p class='cert'>Record: <code>topics/classicism/results/no-pure-contingency-and-relational-choice-imply-necessaryelational-choice.yaml</code></p>
