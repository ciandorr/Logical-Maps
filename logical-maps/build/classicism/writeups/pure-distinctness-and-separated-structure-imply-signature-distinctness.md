# Distinctness (pure) ∧ Separated Structure ⇒ Distinctness (signature Σ)
...
<p class='cert'>Record: <code>topics/classicism/results/pure-distinctness-and-separated-structure-imply-signature-distinctness.yaml</code></p>
