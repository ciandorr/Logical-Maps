# Witnessed Possibility ∧ ND ⇒ False (⊥)
...
- **Proof: Logical Combinatorialism.** Bacon, Andrew (2020). Logical Combinatorialism. Philosophical Review 129(4), 537–589. As cited in Classicism, §§2.5 and 3.5. — pp. 554–555, nn. 29–30. Bacon derives from Logical Necessity that distinct fundamental entities are possibly identical (his (4)), so that distinctness is contingent and the Brouwerian axiom, and with it ND (Prior), fail.
