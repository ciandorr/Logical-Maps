# □Infinitary distribution ($\Diamond_\infty$) ⇒ Infinitary distribution ($\Diamond_\infty$)
...
<p class='cert'>Record: <code>topics/intuitionisticism/results/necessary-infinitary-distribution-infinity-implies-distribution.yaml</code></p>
