# □PSb ($\Diamond_\infty$) ⇒ PSb ($\Diamond_\infty$)
...
<p class='cert'>Record: <code>topics/intuitionisticism/results/necessary-ps-b-possibility-infinity-implies-ps-b.yaml</code></p>
