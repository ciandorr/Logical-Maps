# □A PSb–PSd operator exists ⇒ A PSb–PSd operator exists
...
- **Codex connecting proofs, 13 Sep 2026** — Codex (GPT-6), connecting proof unbox-exists-ps-b-d, 2026-09-13.
...
<p class='cert'>Record: <code>topics/intuitionisticism/results/unbox-exists-ps-b-d.yaml</code></p>
