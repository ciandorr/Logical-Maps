# □Infinitary distribution (≠⊥) ⇒ Infinitary distribution (≠⊥)
...
- **Codex connecting proofs, 13 Sep 2026** — Codex (GPT-6), connecting proof unbox-infinitary-distribution-distinct-from-bottom, 2026-09-13.
...
<p class='cert'>Record: <code>topics/intuitionisticism/results/unbox-infinitary-distribution-distinct-from-bottom.yaml</code></p>
