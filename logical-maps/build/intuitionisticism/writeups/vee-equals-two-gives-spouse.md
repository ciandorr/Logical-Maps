...
- **Codex connecting proof, 13 Sep 2026** — Codex (GPT-6), connecting proof recorded 13 September 2026 in vee-equals-two-gives-spouse.
...
<p class='cert'>Record: <code>topics/intuitionisticism/results/vee-equals-two-gives-spouse.yaml</code></p>
