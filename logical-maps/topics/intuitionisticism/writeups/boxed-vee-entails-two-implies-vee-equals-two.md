# □$\Diamond_\vee$ entails ◇₂ ⇒ $\Diamond_\vee$ = ◇₂
...
- **Codex connecting proofs, 13 Sep 2026** — Codex (GPT-6), connecting proof boxed-vee-entails-two-implies-vee-equals-two, 2026-09-13.
...
<p class='cert'>Record: <code>topics/intuitionisticism/results/boxed-vee-entails-two-implies-vee-equals-two.yaml</code></p>
