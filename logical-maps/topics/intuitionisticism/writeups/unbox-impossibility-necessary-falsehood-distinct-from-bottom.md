# □Impossibility ⇒ necessary falsehood (≠⊥) ⇒ Impossibility ⇒ necessary falsehood (≠⊥)
...
- **Codex connecting proofs, 13 Sep 2026** — Codex (GPT-6), connecting proof unbox-impossibility-necessary-falsehood-distinct-from-bottom, 2026-09-13.
...
<p class='cert'>Record: <code>topics/intuitionisticism/results/unbox-impossibility-necessary-falsehood-distinct-from-bottom.yaml</code></p>
