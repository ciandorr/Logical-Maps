# □$\Diamond_\infty$ entails ◇₂ ⇒ $\Diamond_\infty$ entails ◇₂

<p class='cert'>Result — Source: Misc.; produced by Codex (GPT-6), connecting proof; recorded by Codex (GPT-6).</p>

## Premises

- **□$\Diamond_\infty$ entails ◇₂.** $\Box (\forall p:t$. $\Diamond_\infty$$p \to \Diamond _{2}p$)
...
- **Codex connecting proofs, 13 Sep 2026** — Codex (GPT-6), connecting proof unbox-infinity-entails-two, 2026-09-13.
...
<p class='cert'>Record: <code>topics/intuitionisticism/results/unbox-infinity-entails-two.yaml</code></p>
