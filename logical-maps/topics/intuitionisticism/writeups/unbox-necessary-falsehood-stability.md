...
- **Codex connecting proofs, 13 Sep 2026** — Codex (GPT-6), connecting proof unbox-necessary-falsehood-stability, 2026-09-13.
...
<p class='cert'>Record: <code>topics/intuitionisticism/results/unbox-necessary-falsehood-stability.yaml</code></p>
