# □Propositional intensionalism (□₂) ⇒ Propositional intensionalism (□₂)
...
- **Codex connecting proofs, 13 Sep 2026** — Codex (GPT-6), connecting proof unbox-necessity-two-intensionalism, 2026-09-13.
...
<p class='cert'>Record: <code>topics/intuitionisticism/results/unbox-necessity-two-intensionalism.yaml</code></p>
