...
- **◇₂ entails Truth.** $\forall p:t. \Diamond _{2}p \to p$
...
- **Codex connecting proofs, 13 Sep 2026** — Codex (GPT-6), connecting proof unbox-two-entails-truth, 2026-09-13.
...
<p class='cert'>Record: <code>topics/intuitionisticism/results/unbox-two-entails-truth.yaml</code></p>
