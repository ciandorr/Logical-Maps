...
- **Codex connecting proofs, 13 Sep 2026** — Codex (GPT-6), connecting proof vee-equals-two-is-self-necessitating, 2026-09-13.
...
<p class='cert'>Record: <code>topics/intuitionisticism/results/vee-equals-two-is-self-necessitating.yaml</code></p>
