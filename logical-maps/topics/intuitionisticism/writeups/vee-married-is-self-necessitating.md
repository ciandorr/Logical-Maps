# Spouse ($\Diamond_\vee$) ⇒ □Spouse ($\Diamond_\vee$)
...
- **Codex connecting proofs, 13 Sep 2026** — Codex (GPT-6), connecting proof vee-married-is-self-necessitating, 2026-09-13.
...
<p class='cert'>Record: <code>topics/intuitionisticism/results/vee-married-is-self-necessitating.yaml</code></p>
