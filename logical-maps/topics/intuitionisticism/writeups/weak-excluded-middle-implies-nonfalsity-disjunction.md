...
Assume ¬¬(p∨q) and instantiate weak excluded middle at p. If ¬¬p, inject into the conclusion. If ¬p, then ¬q would refute p∨q, contrary to the assumption; hence ¬¬q. Discharge the assumption and generalize p,q.
